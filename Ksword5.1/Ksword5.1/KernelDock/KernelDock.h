...
private:
    ...
    // m_driverStartIoTab：DriverStartIo 子页，惰性首刷统一走 ensureIoManagementTabInitialized。
    KernelDriverStartIoTab* m_driverStartIoTab = nullptr;
