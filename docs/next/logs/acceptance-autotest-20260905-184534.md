...
时间(UTC): 2026-09-05T22:45:34.2951147Z → 2026-09-05T22:46:02.7592333Z
...
| prune:before-driver-load-0905-1830 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-self-test-0905-183737 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:launch-test-guest | OK |  |
| alive:launch-test-guest | OK | 虚拟机仍然响应 |
| launch-test-guest | OK |  |

---

BLOCKED 表示缺能力/权限/样本，**不等于通过**；NOT_RUN 表示这一段本次没跑。
原始 JSON: `acceptance-autotest-20260905-184534.json`
