...
时间(UTC): 2026-09-05T23:07:12.6604456Z → 2026-09-05T23:32:42.6038524Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-kdebug-0905-185114 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-launch-test-guest-0905-184552 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-self-test-0905-184543 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-resident-0905-183744 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-kdebug-0905-190249 | OK | 自动修剪旧检查点以回收磁盘 |
...
原始 JSON: `acceptance-autotest-20260905-190712.json`
