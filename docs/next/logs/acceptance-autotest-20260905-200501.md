...
时间(UTC): 2026-09-06T00:05:01.9617129Z → 2026-09-06T00:05:15.4264040Z
...
|---|---|---|
| deploy:hvm_ctl | OK |  |
| status | FAIL | 设备查询失败 —— 驱动可能没加载 |

### 备注

- hvm_ctl status 拿不到结果，后续全部未运行。先跑 Deploy-KswordDriverToVm.ps1。

---

BLOCKED 表示缺能力/权限/样本，**不等于通过**；NOT_RUN 表示这一段本次没跑。
原始 JSON: `acceptance-autotest-20260905-200501.json`
