...
时间(UTC): 2026-09-06T02:49:37.8342856Z → 2026-09-06T02:50:16.9596344Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-self-test-0905-214232 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-driver-load-0905-2140 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-resident-0905-214238 | OK | 自动修剪旧检查点以回收磁盘 |
...
原始 JSON: `acceptance-autotest-20260905-224937.json`
