...
时间(UTC): 2026-09-06T03:24:56.6647619Z → 2026-09-06T03:25:32.9622496Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-self-test-0905-232238 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-driver-load-0905-2322 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-resident-0905-232245 | OK | 自动修剪旧检查点以回收磁盘 |
...
原始 JSON: `acceptance-autotest-20260905-232456.json`
