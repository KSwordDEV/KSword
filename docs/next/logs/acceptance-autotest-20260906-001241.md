...
时间(UTC): 2026-09-06T04:12:41.8227965Z → 2026-09-06T04:13:53.3516402Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-self-test-0906-000812 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-driver-load-0906-0007 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-soak-0906-000819 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:soak | OK |  |
| alive:soak | OK | 虚拟机仍然响应 |
| soak | FAIL |  |

### 备注

- soak 返回 NO_JSON（lastStatus=?）；后续级别不再执行。

---

BLOCKED 表示缺能力/权限/样本，**不等于通过**；NOT_RUN 表示这一段本次没跑。
原始 JSON: `acceptance-autotest-20260906-001241.json`
