...
时间(UTC): 2026-09-06T04:24:03.7967688Z → 2026-09-06T04:24:29.6746186Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-self-test-0906-001921 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-driver-load-0906-0018 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-soak-0906-001927 | OK | 自动修剪旧检查点以回收磁盘 |
...
原始 JSON: `acceptance-autotest-20260906-002403.json`
