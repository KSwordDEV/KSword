...
时间(UTC): 2026-09-06T04:30:40.6796377Z → 2026-09-06T04:31:16.4354382Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-self-test-0906-002414 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-driver-load-0906-0023 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-resident-0906-002421 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:resident | OK |  |
| alive:resident | OK | 虚拟机仍然响应 |
| resident | OK |  |
| probe-xonly | FAIL | TRANSLATE 失败：status=1 nt=0xC000000D win32=0 |
...
原始 JSON: `acceptance-autotest-20260906-003040.json`
