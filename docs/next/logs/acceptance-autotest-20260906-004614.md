...
时间(UTC): 2026-09-06T04:46:14.3736198Z → 2026-09-06T04:46:54.0072507Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-self-test-0906-004146 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-driver-load-0906-0040 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-probe-xonly-0906-004152 | OK | 自动修剪旧检查点以回收磁盘 |
...
原始 JSON: `acceptance-autotest-20260906-004614.json`
