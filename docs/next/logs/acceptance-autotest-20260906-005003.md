...
时间(UTC): 2026-09-06T04:50:03.3790263Z → 2026-09-06T04:50:39.5915851Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-self-test-0906-004636 | OK | 自动修剪旧检查点以回收磁盘 |
| prune:before-driver-load-0906-0046 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应 |
| self-test | OK |  |
| prune:before-probe-xonly-0906-004642 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:probe-xonly | OK |  |
| alive:probe-xonly | OK | 虚拟机仍然响应 |
| probe-xonly | OK |  |

---

BLOCKED 表示缺能力/权限/样本，**不等于通过**；NOT_RUN 表示这一段本次没跑。
原始 JSON: `acceptance-autotest-20260906-005003.json`
