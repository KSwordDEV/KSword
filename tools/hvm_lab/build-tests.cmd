...
if errorlevel 1 exit /b %errorlevel%
cl /nologo /W4 /WX /O2 tools\hvm_lab\svm_nested_owner_tests.c KswordARKDriver\src\features\hvm\hvm_svm_nested_owner.c /Fe:tools\hvm_lab\svm_nested_owner_tests.exe /Fo:tools\hvm_lab\
if errorlevel 1 exit /b %errorlevel%
tools\hvm_lab\svm_nested_owner_tests.exe
if errorlevel 1 exit /b %errorlevel%
